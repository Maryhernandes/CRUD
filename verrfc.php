...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevorfc.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editar_respuestarfc.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este provedor?")){ 
                    window.location = "eliminarrfc.php?id=" + idx; 
                }
