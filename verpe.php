...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevope.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarpe.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este peinado?")){ 
                    window.location = "eliminarpe.php?id=" + idx; 
                }
