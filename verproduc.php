...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevoproduc.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <table border="2" class="table table-striped">
            ...
            ?>  
                <tr>
                    ...
                    <td><?php echo $usuarios[$x]["descripcion"]; ?></td>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarproduc.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este producto?")){ 
                    window.location = "eliminarproduc.php?id=" + idx; 
                }
