...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevotcabello.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <table border="2" class="table table-striped">
            ...
            ?>  
                <tr>
                    ...
                    <td><?php echo $usuarios[$x]["precio"]; ?></td>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editar_respuestatcabello.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este Usuario?")){ 
                    window.location = "eliminartcabello.php?id=" + idx; 
                }
