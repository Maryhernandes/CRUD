...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevobar.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarbar.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este estilo?")){ 
                    window.location = "eliminarbar.php?id=" + idx; 
                }
