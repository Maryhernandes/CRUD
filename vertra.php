...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevotra.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <table border="2" class="table table-striped">
            ...
            ?>  
                <tr>
                    ...
                    <td><?php echo $usuarios[$x]["producto"]; ?></td>
                    <td><?php echo $usuarios[$x]["tratamiento"]; ?></td>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editartra.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este Tratamiento?")){ 
                    window.location = "eliminartra.php?id=" + idx; 
                }
