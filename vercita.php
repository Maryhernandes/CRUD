...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevocita.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarcita.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a esta cita?")){ 
                    window.location = "eliminarcita.php?id=" + idx; 
                }
