...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevocortes.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editar_respuestacortes.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este corte?")){ 
                    window.location = "eliminarcortes.php?id=" + idx; 
                }
