...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevopeinados.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarpeinados.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este Usuario?")){ 
                    window.location = "eliminarpeinados.php?id=" + idx; 
                }
