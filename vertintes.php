...
<html>
    <head>
        ...
        <a class="btn btn-primary" href="nuevotintes.php">click para añadir</a>
        <style>
    ...
    <body>
        ...
        <script>
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editar_respuestatintes.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("¿Seguro que deseas eliminar a este tinte?")){ 
                    window.location = "eliminartintes.php?id=" + idx; 
                }
